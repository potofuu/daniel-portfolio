    ...
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-24'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
            <div className='col-span-2'>
                ...
                <p className='py-2 text-gray-500'>I am currently a first year student at Georgia Tech, studying CS with threads(focus) in intelligence and media.</p>
                <p className='py-2 text-gray-500'>I am interested in learning about AI/machine learning, data science, and web development. In my free time, I enjoy playing tennis, games and chess.</p>
                <p><br></br></p>
                <Link href='/#projects'>
